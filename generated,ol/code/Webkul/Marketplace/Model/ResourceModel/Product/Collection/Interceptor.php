<?php
namespace Webkul\Marketplace\Model\ResourceModel\Product\Collection;

/**
 * Interceptor class for @see \Webkul\Marketplace\Model\ResourceModel\Product\Collection
 */
class Interceptor extends \Webkul\Marketplace\Model\ResourceModel\Product\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllAssignProducts');
        return $pluginInfo ? $this->___callPlugins('getAllAssignProducts', func_get_args(), $pluginInfo) : parent::getAllAssignProducts($condition, $limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllSellerIds');
        return $pluginInfo ? $this->___callPlugins('getAllSellerIds', func_get_args(), $pluginInfo) : parent::getAllSellerIds($limit, $offset);
    }
    ...
    public function setProductData($condition, $attributeData)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setProductData', func_get_args(), $pluginInfo) : parent::setProductData($condition, $attributeData);
    }
    ...
    public function joinCustomer()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('joinCustomer', func_get_args(), $pluginInfo) : parent::joinCustomer();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSellerColumns');
        return $pluginInfo ? $this->___callPlugins('addSellerColumns', func_get_args(), $pluginInfo) : parent::addSellerColumns();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinProductTable');
        return $pluginInfo ? $this->___callPlugins('joinProductTable', func_get_args(), $pluginInfo) : parent::joinProductTable();
    }
