<?php
namespace Webkul\Marketplace\Model\ResourceModel\Saleslist\Collection;

/**
 * Interceptor class for @see \Webkul\Marketplace\Model\ResourceModel\Saleslist\Collection
 */
class Interceptor extends \Webkul\Marketplace\Model\ResourceModel\Saleslist\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllOrderIds');
        return $pluginInfo ? $this->___callPlugins('getAllOrderIds', func_get_args(), $pluginInfo) : parent::getAllOrderIds($limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllRemainOrderRowIds');
        return $pluginInfo ? $this->___callPlugins('getAllRemainOrderRowIds', func_get_args(), $pluginInfo) : parent::getAllRemainOrderRowIds($limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllOrderProducts');
        return $pluginInfo ? $this->___callPlugins('getAllOrderProducts', func_get_args(), $pluginInfo) : parent::getAllOrderProducts();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllSoldQty');
        return $pluginInfo ? $this->___callPlugins('getAllSoldQty', func_get_args(), $pluginInfo) : parent::getAllSoldQty($limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTotalSellerAmount');
        return $pluginInfo ? $this->___callPlugins('getTotalSellerAmount', func_get_args(), $pluginInfo) : parent::getTotalSellerAmount($limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTotalSellerTaxAmount');
        return $pluginInfo ? $this->___callPlugins('getTotalSellerTaxAmount', func_get_args(), $pluginInfo) : parent::getTotalSellerTaxAmount($limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTotalAdminTaxAmount');
        return $pluginInfo ? $this->___callPlugins('getTotalAdminTaxAmount', func_get_args(), $pluginInfo) : parent::getTotalAdminTaxAmount($limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTotalSellerCodCharges');
        return $pluginInfo ? $this->___callPlugins('getTotalSellerCodCharges', func_get_args(), $pluginInfo) : parent::getTotalSellerCodCharges($limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTotalSellerInvoiceCodCharges');
        return $pluginInfo ? $this->___callPlugins('getTotalSellerInvoiceCodCharges', func_get_args(), $pluginInfo) : parent::getTotalSellerInvoiceCodCharges($invoiceId, $limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTotalSellerCreditmemoCodCharges');
        return $pluginInfo ? $this->___callPlugins('getTotalSellerCreditmemoCodCharges', func_get_args(), $pluginInfo) : parent::getTotalSellerCreditmemoCodCharges($creditmemoId, $limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSellerOrderTotal');
        return $pluginInfo ? $this->___callPlugins('getSellerOrderTotal', func_get_args(), $pluginInfo) : parent::getSellerOrderTotal($limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPricebyorderData');
        return $pluginInfo ? $this->___callPlugins('getPricebyorderData', func_get_args(), $pluginInfo) : parent::getPricebyorderData($limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTotalCustomersCount');
        return $pluginInfo ? $this->___callPlugins('getTotalCustomersCount', func_get_args(), $pluginInfo) : parent::getTotalCustomersCount();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTotalOrders');
        return $pluginInfo ? $this->___callPlugins('getTotalOrders', func_get_args(), $pluginInfo) : parent::getTotalOrders();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSalesListData');
        return $pluginInfo ? $this->___callPlugins('setSalesListData', func_get_args(), $pluginInfo) : parent::setSalesListData($id, $attributeData);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setWithdrawalRequestData');
        return $pluginInfo ? $this->___callPlugins('setWithdrawalRequestData', func_get_args(), $pluginInfo) : parent::setWithdrawalRequestData($condition, $attributeData);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSellerOrderCollection');
        return $pluginInfo ? $this->___callPlugins('getSellerOrderCollection', func_get_args(), $pluginInfo) : parent::getSellerOrderCollection();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOrderedProductId');
        return $pluginInfo ? $this->___callPlugins('getOrderedProductId', func_get_args(), $pluginInfo) : parent::getOrderedProductId($limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllBuyerIds');
        return $pluginInfo ? $this->___callPlugins('getAllBuyerIds', func_get_args(), $pluginInfo) : parent::getAllBuyerIds($limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSellerOrderTotalsQuery');
        return $pluginInfo ? $this->___callPlugins('getSellerOrderTotalsQuery', func_get_args(), $pluginInfo) : parent::getSellerOrderTotalsQuery($idsSelect);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSellerOrderTotals');
        return $pluginInfo ? $this->___callPlugins('getSellerOrderTotals', func_get_args(), $pluginInfo) : parent::getSellerOrderTotals($limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSellerInvoiceTotals');
        return $pluginInfo ? $this->___callPlugins('getSellerInvoiceTotals', func_get_args(), $pluginInfo) : parent::getSellerInvoiceTotals($invoiceId, $limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinMarketplaceProductTable');
        return $pluginInfo ? $this->___callPlugins('joinMarketplaceProductTable', func_get_args(), $pluginInfo) : parent::joinMarketplaceProductTable();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFieldToCollection');
        return $pluginInfo ? $this->___callPlugins('addFieldToCollection', func_get_args(), $pluginInfo) : parent::addFieldToCollection($field, $expression);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'resetColumns');
        return $pluginInfo ? $this->___callPlugins('resetColumns', func_get_args(), $pluginInfo) : parent::resetColumns();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFieldsToCollection');
        return $pluginInfo ? $this->___callPlugins('addFieldsToCollection', func_get_args(), $pluginInfo) : parent::addFieldsToCollection($fields);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFieldQuery');
        return $pluginInfo ? $this->___callPlugins('getFieldQuery', func_get_args(), $pluginInfo) : parent::getFieldQuery($field, $table, $alias, $condition, $groupByField);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setConditionalValue');
        return $pluginInfo ? $this->___callPlugins('setConditionalValue', func_get_args(), $pluginInfo) : parent::setConditionalValue($query, $compareValue, $defaultValue);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addStoreWiseSellerColumns');
        return $pluginInfo ? $this->___callPlugins('addStoreWiseSellerColumns', func_get_args(), $pluginInfo) : parent::addStoreWiseSellerColumns();
    }
