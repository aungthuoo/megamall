...
class Interceptor extends \Webkul\Marketplace\Block\Profile implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFeed');
        return $pluginInfo ? $this->___callPlugins('getFeed', func_get_args(), $pluginInfo) : parent::getFeed();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFeedCollection');
        return $pluginInfo ? $this->___callPlugins('getFeedCollection', func_get_args(), $pluginInfo) : parent::getFeedCollection();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBestsellProducts');
        return $pluginInfo ? $this->___callPlugins('getBestsellProducts', func_get_args(), $pluginInfo) : parent::getBestsellProducts();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSellerFlagReasons');
        return $pluginInfo ? $this->___callPlugins('getSellerFlagReasons', func_get_args(), $pluginInfo) : parent::getSellerFlagReasons();
    }
