...
class Interceptor extends \Webkul\Marketplace\Block\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function _getProductCollection()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('_getProductCollection', func_get_args(), $pluginInfo) : parent::_getProductCollection();
    }

    /**
     * {@inheritdoc}
     */
    public function configureProductToolbar(\Magento\Catalog\Block\Product\ProductList\Toolbar $toolbar, \Magento\Catalog\Model\ResourceModel\Product\Collection $collection)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'configureProductToolbar');
        return $pluginInfo ? $this->___callPlugins('configureProductToolbar', func_get_args(), $pluginInfo) : parent::configureProductToolbar($toolbar, $collection);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultDirection');
        return $pluginInfo ? $this->___callPlugins('getDefaultDirection', func_get_args(), $pluginInfo) : parent::getDefaultDirection();
    }
    ...
    public function getSortBy()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSortBy', func_get_args(), $pluginInfo) : parent::getSortBy();
    }
    ...
    public function getProfileDetail()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getProfileDetail', func_get_args(), $pluginInfo) : parent::getProfileDetail();
    }
