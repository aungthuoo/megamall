<?php
namespace Webkul\Marketplace\Model\Rewrite\Catalog\ResourceModel\Product\Collection;

/**
 * Interceptor class for @see \Webkul\Marketplace\Model\Rewrite\Catalog\ResourceModel\Product\Collection
 */
class Interceptor extends \Webkul\Marketplace\Model\Rewrite\Catalog\ResourceModel\Product\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinSellerProducts');
        return $pluginInfo ? $this->___callPlugins('joinSellerProducts', func_get_args(), $pluginInfo) : parent::joinSellerProducts();
    }
