<?php
namespace Webkul\Marketplace\Model\ResourceModel\Saleperpartner\Collection;

/**
 * Interceptor class for @see \Webkul\Marketplace\Model\ResourceModel\Saleperpartner\Collection
 */
class Interceptor extends \Webkul\Marketplace\Model\ResourceModel\Saleperpartner\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTotalAmountRemain');
        return $pluginInfo ? $this->___callPlugins('getTotalAmountRemain', func_get_args(), $pluginInfo) : parent::getTotalAmountRemain();
    }
