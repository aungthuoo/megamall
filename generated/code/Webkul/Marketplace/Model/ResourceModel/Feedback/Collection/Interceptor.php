<?php
namespace Webkul\Marketplace\Model\ResourceModel\Feedback\Collection;

/**
 * Interceptor class for @see \Webkul\Marketplace\Model\ResourceModel\Feedback\Collection
 */
class Interceptor extends \Webkul\Marketplace\Model\ResourceModel\Feedback\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllReviewCount');
        return $pluginInfo ? $this->___callPlugins('getAllReviewCount', func_get_args(), $pluginInfo) : parent::getAllReviewCount($type, $starType, $limit, $offset);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAllRatingColumns');
        return $pluginInfo ? $this->___callPlugins('addAllRatingColumns', func_get_args(), $pluginInfo) : parent::addAllRatingColumns();
    }
